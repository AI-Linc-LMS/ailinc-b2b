        ...
        <div className="relative py-4 overflow-hidden">
          <div className="flex gap-6 animate-scroll-horizontal">
            ...
            {[
              ...
              <div
                key={idx}
                className="min-w-[260px] min-h-[200px] max-w-[280px] bg-white rounded-2xl shadow-md border border-gray-200 flex-shrink-0 snap-center transition-transform duration-300 hover:scale-105 hover:shadow-xl transform-gpu"
